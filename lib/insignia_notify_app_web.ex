defmodule InsigniaNotifyAppWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: InsigniaNotifyAppWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {InsigniaNotifyAppWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: InsigniaNotifyAppWeb.Endpoint,
        router: InsigniaNotifyAppWeb.Router,
        statics: InsigniaNotifyAppWeb.static_paths()
    end
  end
