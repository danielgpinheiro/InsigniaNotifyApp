defmodule InsigniaNotifyAppWeb.SessionHooks.RequireUser do
  @moduledoc """
  ...
  This hook should follow `InsigniaNotifyAppWeb.SessionHooks.AssignUser` in a `Phoenix.LiveView.Router.live_session/3`.
